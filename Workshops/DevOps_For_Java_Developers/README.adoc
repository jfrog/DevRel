...
Click on "Xray Security & Compliance" in the menu and then choose "Indexed Resources".
...
Navigate to the Application module in your JFrog Platform instance, expand the Security & Compliance menu and select "Policies".
...
Navigate to the Application module in your JFrog Platform instance, expand the Security & Compliance menu and select "Watch".
