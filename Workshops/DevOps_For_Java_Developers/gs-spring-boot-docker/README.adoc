...
TIP: Of course, if you use only Gradle, you could change the `Dockerfile` to make the default value of `DEPENDENCY` match the location of the unpacked archive.
