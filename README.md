...
2. **Browse available resources:**
   Navigate to the folder that interests you (e.g., `workshops/`, `demos/`)

3. **Follow the instructions:**
   Each resource contains its own README with setup and execution instructions
...
<!-- Example format:
- **[Workshop Name](./workshops/workshop-name/)** - Brief description
  - Duration: X hours
...
<!-- Example format:
- **[Demo Name](./demos/demo-name/)** - Brief description
...
<!-- Example format:
- **[Tutorial Name](./tutorials/tutorial-name/)** - Brief description
-->
...
<!-- Example format:
- **[Event Name - Talk Title](./presentations/event-name/)** - Date, Location
-->
...
**Have a suggestion?** [Open an issue](../../issues) with the `enhancement` label!
...
[Report Bug](../../issues) · [Request Feature](../../issues) · [Start Discussion](../../discussions)
